# Graph Report - Claude  (2026-06-06)

## Corpus Check
- 60 files · ~81,164 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 238 nodes · 321 edges · 20 communities (18 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `660917a5`
...
Cohesion: 0.11
Nodes (13): IconArrowRight(), IconDownload(), IconEmail(), IconExternal(), IconGithub(), IconLinkedIn(), IconMoon(), IconScrollDown() (+5 more)

### Community 7 - "Community 7"
Cohesion: 0.48
Nodes (3): Certifications(), certifications, useCreedlyData()
...
Cohesion: 0.10
Nodes (9): pages, about, education, experience, hero, personal, projects, skills (+1 more)
...
Cohesion: 0.33
Nodes (3): CATEGORY_META, DEVICON, EMOJI_BADGE

## Knowledge Gaps
- **94 isolated node(s):** `DEVICON`, `EMOJI_BADGE`, `CATEGORY_META`, `s`, `projectIcons` (+89 more)
...
- **What connects `DEVICON`, `EMOJI_BADGE`, `CATEGORY_META` to the rest of the system?**
